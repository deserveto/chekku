...
// Task 5 extends CompetitiveSlidesProps with variant/anchorProduct/createdAt.
// Until then, narrow the view locally so this route typechecks on its own.
const PublicSlides = CompetitiveSlides as unknown as ComponentType<{
  variant: string;
  analysisId: string;
